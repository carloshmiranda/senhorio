        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Cheaper than hiring an accountant</p>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-blue-600 mb-2">100%</div>
              <p className="text-gray-600">Compliant with Portuguese tax law</p>
            </div>
            <div className="text-center">
      ...
      <section id="faq" className="max-w-4xl mx-auto px-6 py-20">
        ...
        <div className="space-y-6">
          {[
            ...
            {
              q: "Are the rent receipts (Recibos de Renda) legally compliant?",
              a: "Yes, all receipts generated by Senhorio meet Portuguese legal requirements, including proper formatting, required fields, and tax information. They're accepted by Portal das Finanças and tenants can use them for their IRS declarations."
            },
            {
            ...
            },
            {
              ...
              a: "Our tax calculations are based on official Portuguese tax law and are updated annually. However, Senhorio is a tool to help you calculate taxes, not professional tax advice. For complex situations, consult with a qualified accountant."
            },
            {
